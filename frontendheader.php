...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
				...
				<a href="shop_cart.php" class="text-decoration-none d-xl-inline d-lg-inline d-md-inline d-sm-none d-none shoppingcartLink"> 
				...
				<div class="hov-dropdown d-inline-block">
          			...
          			<div class="dropdown-menu" aria-labelledby="navbarDropdown2">
						 ...
						 ?>
            					...
            					<a class="dropdown-item" href="brand.php?id=<?= $bid ?>"> <?= $bname ?> 
            				</a>
            			<?php endforeach; ?>
	...
	<div id="mySidebar" class="sidebar">
		...
		<div class="mt-3">
			...
			<a data-toggle="collapse" href="#loginandsign" role="button" aria-expanded="false" aria-controls="loginandsign">
			...
			<div class="collapse sidebardropdown_container_category mt-3" id="loginandsign">
			    <a href="#" class="py-2"> Profile </a>
			    <a href="#" class="py-2"> Order History </a>
			...
			<a href="shop_cart.php"> Cart [ <span class="cartNoti">  </span> ]  </a>
			<hr>
