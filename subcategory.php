		...
		<div class="row mt-5">
			...
			<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
				...
				<div class="row">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
							<div class="card pad15 mb-3">
							  	...
							  	<div class="card-body text-center">
									...
									<!-- <a href="javascript:void(0)" class="add_btn text-decoration-none" data-id="<?= $itid ?>"
										data-name="<?= $itname; ?>" data-photo="<?= $itphoto; ?>" data-codeno="<?= $itcodeno; ?>" data-price="<?= $itprice; ?>" data-discount="<?= $itdiscount; ?>">Add to Cart</a> -->
									<a><button 
										 data-id="<?= $itid ?>" data-photo = "<?=$itphoto ?>" data-name="<?= $itname; ?>"
										 data-codeno="<?= $itcodeno; ?>"
										 data-price = "<?= $itprice; ?>"
										 data-discount = "<?= $itdiscount; ?>"
										 class=" text-decoration-none btn_add">Add to Cart
									</button>
									</a>
							  	</div>
							</div>
					...
					<div class="col-12">
						<img src="images/no_products_found.png" class="img-fluid mx-auto d-block">
					</div>
