...
<html lang="en">
    <head>
        ...
        <link rel="apple-toch-icon" sizes="120x120" href="favicon/apple-icon-120x120.png">
    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="images/user.png" width="40px" height="40px" alt="User Imag">
                <div>
