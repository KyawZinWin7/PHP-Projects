                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input class="form-control py-4" id="inpassword" type="password" placeholder="Enter password" name="password" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input class="form-control py-4" id="conpassword" type="password" placeholder="Confirm password"  name="cpassword" />
